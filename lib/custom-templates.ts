// Custom (user-uploaded) WhatsApp templates — a workspace defines its OWN
// templates, merged over the built-in catalog (a custom key OVERRIDES a built-in
// one with the same key). Backed by the custom_templates table.
import { createAdmin } from '@/lib/supabase/admin';
import { TEMPLATES, type TemplateDef } from '@/lib/whatsapp-catalog';
